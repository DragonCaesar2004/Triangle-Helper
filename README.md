...
Данный проект — Telegram-бот, который позволяет пользователю вычислить все возможные параметры треугольника на основе минимального набора исходных данных.  
...
- **PythonAnywhere** — сервер для деплоя.
...
- **itertools** — работа с перестановками.
...
8. Развернуть проект на сервере PythonAnyWhere.
